...
class RolesAndPermissionsSeeder extends Seeder
{
    public function run(): void
    {
        ...
        $roles = [
            ...
            'teacher' => ['students.view', 'students.create', 'students.update', 'students.archive', 'halaqas.view', 'recitations.view', 'recitations.create', 'recitations.update', 'recitations.export', 'attendance.manage', 'reports.view', 'calendar.view', 'notifications.view', 'alerts.view'],

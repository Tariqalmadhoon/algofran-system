@php($whatsappUrl = app(\App\Services\PublicContactService::class)->whatsappUrl())

<a href="{{ $whatsappUrl }}" target="_blank" rel="noopener noreferrer" data-no-navigation-feedback class="whatsapp-float" aria-label="تواصل مع مركز الغفران عبر واتساب">
    <span class="whatsapp-float-rings" aria-hidden="true"></span>
    <svg class="whatsapp-float-icon" viewBox="0 0 32 32" fill="currentColor" aria-hidden="true">
    ...
    <span class="whatsapp-float-label">تواصل عبر واتساب</span>
</a>
